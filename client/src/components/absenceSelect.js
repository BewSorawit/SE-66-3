...
function AbsenceSelect({ user }) {
  ...
  const inBranch = async (shiftDetail) => {
    try {
      ...
      const response = await axios.put(
        `${process.env.REACT_APP_API_URL}/absences/updateStatus/${shiftDetail.absenceID}`,
        { status: "success" }
      );
      navigate("/absenceManagePage/absenceEditEmp", {
        state: { shiftDetail: shiftDetail },
      });
  ...
  return (
    <div className="bg-success" style={{ minHeight: "100vh", padding: "50px" }}>
      <section
        className="rounded border mx-auto border-3 bg-white"
        style={{ width: "1300px", padding: "25px" }}
      >
        <div>
            ...
            <div className="d-flex justify-content-center mb-3">
              ...
              <div className="d-inline">
                <input
                  ...
                  value={shiftDetail.firstName + " " + shiftDetail.surName}
                  style={{ width: "300px" }}
                  readOnly
                />
              </div>
            ...
            <div className="d-flex justify-content-center mb-3">
              ...
              <div className="d-inline">
                <input
                  type="text"
                  className="form-control border-2"
                  value={moment(shiftDetail.leaveDate).format("DD/MM/YYYY")}
                  style={{ width: "300px" }}
                  readOnly
                />
              </div>
            ...
            <div className="d-flex justify-content-center mb-3">
              ...
              <div className="d-inline">
                <input
                  type="text"
                  className="form-control border-2"
                  value={shiftRange(shiftDetail.start, shiftDetail.end)}
                  style={{ width: "300px" }}
                  readOnly
                />
              </div>
